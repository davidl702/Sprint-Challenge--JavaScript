...
zooAnimals.forEach((index) => {
  return animalNames.push(`Name: ${index.animal_name} Scientific: ${index.scientific_name} `)
})
...
zooAnimals.map((index) => {
  return lowerCase.push(index.animal_name.toLowerCase())
})
...
*/
const populationTotal = zooAnimals.reduce(function(value1, value2){
  return value1 + value2.population
}, 0);
